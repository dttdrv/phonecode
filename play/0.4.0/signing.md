...
Status: **BLOCKED — no signed 0.4.0 AAB, certificate record, or Play App Signing evidence is present
...
| Version name/code | Source currently declares `0.4.0` / `40`; BLOCKED until confirmed from the signed AAB |
