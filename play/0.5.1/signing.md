...
Status: **BLOCKED — no signed 0.5.1 AAB, certificate record, or Play App Signing evidence is present
...
| Version name/code | Source currently declares `0.5.1` / `51`; BLOCKED until confirmed from the signed AAB |
