...
| Version name | `0.5.1` | Repository source is configured; confirm from the final AAB manifest |
| Version code | `51` | Confirm from the final AAB |
...
| Version identity | BLOCKED | AAB reports version name `0.5.1` and a Play-acceptable monotonic version code |
