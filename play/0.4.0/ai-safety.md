...
way to report or flag offensive content. This worksheet covers both obligations for the exact 0.4.0
...
| Tool permission boundary | Mutating tools can require an explicit approval and untrusted repository, web, MCP, and tool-result text is described as data rather than authority | BLOCKED — verify every release mode and tool surface on device |
