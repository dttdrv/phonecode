...
- Authenticated host-project workspace transport into the production isolated-VM backend; the
  controller, turn-runtime selection, and ready/command/graceful-shutdown protocol are source-wired.
